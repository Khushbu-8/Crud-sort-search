          ...
          <tr>
            ...
            <th scope="col">
              <button
                ...
                onClick={() => DeletAll()}>Delet All </button>
            </th>
            <th scope="col">
              <button
            ...
            filter.map((val) => {
              ...
              return (
                ...
                <tr key={id} >
                  ...
                  <td>
                    <button
                      className="bg-danger btn text-white mb-1"
                      onClick={() => RecordDel(id)}>Delete</button>
                    <button className="bg-info btn  text-white" onClick={()=>navigate('/edit',{state : val})}  >Edit</button>
                  </td>
                  <td>
                    <input
                      type="checkbox"
